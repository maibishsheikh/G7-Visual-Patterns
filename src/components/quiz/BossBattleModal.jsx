...
// Boss Battle challenge mode (5 Questions, 3 Lives)
      ...
      <div className="boss-modal-backdrop">
        <div className="boss-modal-card glass-card anim-bounce-in">
          ...
          <p className="boss-desc">
            Answer {questions.length} visual pattern questions correctly to pass the master critique!
          </p>
          <div className="boss-lives-preview">Lives: {'❤️'.repeat(3)}</div>
    ...
    return (
      <div className="boss-modal-backdrop">
        <div className="boss-modal-card glass-card anim-celebrate">
          <div className="boss-avatar-pulse" style={{ background: 'rgba(16, 185, 129, 0.4)' }}>
            <span className="boss-emoji">🏆</span>
          </div>
          <h2 className="boss-title" style={{ color: 'var(--green-light)' }}>
            Critique Passed!
          </h2>
          <p className="boss-desc">
    ...
    return (
      <div className="boss-modal-backdrop">
        <div className="boss-modal-card glass-card anim-shake">
          <div className="boss-avatar-pulse" style={{ background: 'rgba(244, 63, 94, 0.4)' }}>
            <span className="boss-emoji">💔</span>
          </div>
          <h2 className="boss-title" style={{ color: 'var(--red-light)' }}>
            Out of Lives!
          </h2>
          <p className="boss-desc">
            {boss.name}'s critique was too tough! Review pattern transformations and try again.
          </p>
